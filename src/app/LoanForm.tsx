...
export default function LoanForm({ loan }: LoanFormProps) {
  ...
  return (
    <form
      ...
      className="p-6 max-w-md mx-auto bg-slate-700 text-white rounded-lg shadow-lg"
    >
      ...
      <label className="block mb-3">
        ...
        <input
          ...
          className="mt-1 w-full p-2 rounded border border-gray-700 bg-slate-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          required
        />
      </label>
      ...
      <label className="block mb-3">
        ...
        <div className="relative mt-1 w-full">
          ...
          <input
            ...
            className="pl-7 p-2 rounded border border-gray-700 bg-slate-700 text-white w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
            required
          />
        </div>
      </label>
